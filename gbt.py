...
print("Produits composés de P3 et P5 uniquement :", produits_composes_P3_P5)


produits_sans_P2 = re.findall(r'P\d+ est un produit composé de (?:(P2).)+', exemple)
print("Produits composés sans P2 dans leur composition :", produits_sans_P2)

# 5. Les produits qui composent P9
produits_de_P9 = re.findall(r'P9 est un produit composé de (.+?)\n', exemple)
print("Produits qui composent P9 :", produits_de_P9)